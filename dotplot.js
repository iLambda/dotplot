...
},{"./lib/dotplot.js":2}],2:[function(require,module,exports){
      ...
      if (positive) {
        _.forEach(dotplot.data, function (column, x) {
          if (column.length == 0) {
            ...
            // TODO : CHECK THIS PART OF THE METHOD
            var lasty = undefined
            _.forEach(column, function (y) {
...
},{"canvas-browserify":3,"lodash":4,"sparse-binary-matrix":5}],3:[function(require,module,exports){
...
module.exports = {
  ...
  xor: function(sbmA, sbmB) {
    ...
    // populate
    for (var i = 0; i < mat.x; i++) {
      mat.data[i] = _.xor(sbmA.data[i], sbmB.data[i]).sort()
    }
    // return matrix
    return mat
  },
